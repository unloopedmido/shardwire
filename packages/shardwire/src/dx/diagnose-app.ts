...
export const EVENT_SUBSCRIPTION_METADATA_KEYS: Record<BotEventName, ReadonlySet<ShardwireSubscriptionFilterKey>> = {
	...
	messageCreate: new Set(['guildId', 'channelId', 'userId', 'channelType', 'parentChannelId', 'threadId']),
	messageUpdate: new Set(['guildId', 'channelId', 'userId', 'channelType', 'parentChannelId', 'threadId']),
	messageDelete: new Set(['guildId', 'channelId', 'channelType', 'parentChannelId', 'threadId']),
	messageBulkDelete: new Set(['guildId', 'channelId', 'channelType', 'parentChannelId', 'threadId']),
	messageReactionAdd: new Set(['guildId', 'channelId', 'userId']),
	messageReactionRemove: new Set(['guildId', 'channelId', 'userId']),
