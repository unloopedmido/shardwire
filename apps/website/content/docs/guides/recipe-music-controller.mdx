...
Player position, queue, and “now playing” should come from **`fetch('/api/player/...')`** or a small WebSocket **you** own—see [Custom domain contracts (spike)](/docs/concepts/custom-domain-contracts) for why not to tunnel those through Shardwire core.
