...
- **Node.js 22+** is required for app processes (native **`globalThis.WebSocket`**). See [Troubleshooting](https://shardwire.js.org/docs/operations/troubleshooting/#nodejs-below-22-connectbotbridge-requires-globalthiswebsocket).
