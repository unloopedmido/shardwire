...
- Added stable troubleshooting links in runtime and config errors (`See: https://unloopedmido.github.io/shardwire/errors/#…`).
- Added an **Errors** documentation section with anchor-based remediation for common failures.
- Updated GitHub Pages configuration for project-site hosting (`/shardwire` base and HTTPS canonical URL).
