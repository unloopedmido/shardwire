---
title: Changelog
description: Release notes for shardwire and @shardwire/react — with links to the docs that match each era of the API.
---

<Callout type="info" title="Reading this page">
...
This tab covers the **`shardwire`** npm package from **v1.0.0** onward.
